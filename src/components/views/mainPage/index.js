    ...
    jquery('.container').fullpage({
      ...
      afterLoad: function updateSlideNumber(){
        const slideNumber = document.getElementById('slide-number'),
              bodyClass = document.body.classList[0];
      ...
      <div className='container'>
        <section className="section">
          ...
          <div className={s.content}>
            ...
            <br/>
            <p>“The challenge is to be strong, but not rude; be kind, but not weak; be bold, but not a bully; be thoughtful, but not lazy; be humble, but not timid; be proud, but not arrogant; have humor, but without folly.” <br/><span>– Bob Jeffords on being an effective First AD</span></p>
          </div>
